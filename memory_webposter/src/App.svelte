<script>
  ...
  import totm2_pingpong from "./assets/totm2_pingpong.mp4";
...
<div class="howtoplay">
  <div class="text">
    ...
    <p>
      ...
      you want, with the risk of losing your ranking. Wrong selection adds time.
    </p>
  </div>
        ...
        <ol>
          {#each topByRank as player}
            <li>
              ...
              >
              <span class="name">{sanitizeName(player.name)}</span>
            </li>
          {/each}
        </ol>
      </section>
